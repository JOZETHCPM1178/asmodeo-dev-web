        ...
        <div>
          ...
          <div class="detail-body">
            <div>
              ...
              ${window._currentUser ? `<button class="btn btn-ghost" style="width:100%;justify-content:center;color:#ef4444;margin-top:6px" onclick="showReportModal('post','${id}','${(p.title||'').replace(/'/g,"\\'")}')">🚩 Reportar publicación</button>` : ''}
