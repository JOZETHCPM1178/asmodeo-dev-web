...
// ── VirusTotal — copia el link y abre VT ──
function abrirVirusTotal(link) {
  // Copiar link al portapapeles
  navigator.clipboard.writeText(link).then(() => {
    toast('🔗 Link copiado — pégalo en VirusTotal para escanearlo');
  }).catch(() => {});
  // Abrir VirusTotal en pestaña nueva
  window.open('https://www.virustotal.com/gui/home/url', '_blank');
}
window.abrirVirusTotal = abrirVirusTotal;
