  ...
  setMain(`
    <div class="container" style="max-width:700px;padding-top:40px;padding-bottom:80px">
      <div class="form-card">
        ...
        <div class="form-grid2">
          <div class="fg"><label class="lbl">Versión de la app</label><input class="inp" id="s-version" placeholder="ej: 2.5.1"/></div>
          <div class="fg"><label class="lbl">Estado</label>
            <select class="sel" id="s-stability">
...
async function submitPost() {
  ...
  const stability = document.getElementById('s-stability')?.value || 'stable';
